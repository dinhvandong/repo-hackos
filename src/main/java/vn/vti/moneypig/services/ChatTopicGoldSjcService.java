...
import vn.vti.moneypig.repositories.ChatTopicGoldSjcRepository;
import vn.vti.moneypig.utils.DateUtils;

@Service
public class ChatTopicGoldSjcService {

    @Autowired
    ChatTopicGoldSjcRepository chatRepository;
    ...
    public ChatTopicGoldSjc create (ChatTopicGoldSjc chat){

        Long id = sequenceGeneratorService.generateSequence(ChatTopicGoldSjc.SEQUENCE_NAME);
        chat.setId(id);
    ...
    public Page<ChatTopicGoldSjc> getPaginatedChats(int page, int size) {
    ...
    public ChatTopicGoldSjc getLastChat() {
