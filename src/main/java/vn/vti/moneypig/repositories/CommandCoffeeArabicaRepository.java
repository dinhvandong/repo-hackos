...
public interface CommandCoffeeArabicaRepository extends MongoRepository<CommandCoffeeArabica, Long>
{
//
...
//List<CommandCoffeeVn> findLastMessagesWithinTimeframe();
    ...
    List<CommandCoffeeArabica> findLastMessagesWithinTimeframeGroupedByUser();

    List<CommandCoffeeArabica> findByTimeUTCGreaterThanEqual(String timestamp);
